...
public class ACropEntityInteractEvent extends Event implements Cancellable {
    ...
    public ACropEntityInteractEvent(Player player, Location location, AddCropEntity addCropEntity) {
        this.player = player;
